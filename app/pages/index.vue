...
const { MUTEZ, SHARD } = await import('~/utils/constants')
          ...
          <div class="columns">
            <div class="column left-column is-6-desktop is-flex is-justify-content-flex-end is-align-items-center is-flex-svg">
              <Transition
                ...
                mode="out-in"
              >
                <img v-if="clickCount < 5" class="hummingbird" src="~/assets/hummingbird.svg" @click="clickCount += 1">
            ...
            <div class="column is-6 is-12-mobile is-flex is-justify-content-center is-flex-direction-column animate__animated animate__fadeIn animate">
              ...
              <div>
                <NuxtLink to="/docs" class="button is-primary is-outlined has-text-weight-bold">Learn More</NuxtLink>
                <a target="_blank" rel="noopener" class="button is-primary is-outlined has-text-weight-bold stats-link" :href="`https://metrics.kolibri.finance/?network=${store.network}`">
                  Metrics
                </a>
              </div>
            </div>
