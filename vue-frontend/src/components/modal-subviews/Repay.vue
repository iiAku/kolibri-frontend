  ...
  <div class="repay">
    ...
    <div class="field is-horizontal">
      ...
      <div class="field-body is-align-items-center">
        <div class="field">
          <p class="control">
            <progress class="progress" :class="collatoralizationWarningClasses(collateralizedRateAfterRepaying)"  :value="collateralizedRateAfterRepaying.toFixed(2)" max="100"></progress>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="field is-grouped is-grouped-right">
      <p class="heading">
        ...
        <strong v-if="repayAmount && repayAmount > 0" :class="collatoralizationWarningClasses(collateralizedRateAfterRepaying)" class="price-view">{{ collateralizedRateAfterRepaying.toFixed(2) }}%</strong>
  ...
  methods: {
    async repay(){
      try{
        ...
        this.handleWalletError(e, "Unable to repay", "There was an issue with the repay request.")
      } finally {
